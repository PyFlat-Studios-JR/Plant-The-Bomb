...
from src.mapBuilder.src.ImagePainterWidget import ImagePainterWidget
import os
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, dirpath=None):
        ...
        icon = QIcon()
        icon.addFile(u"src/mapBuilder/textures/00_player.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u"src/mapBuilder/textures/01_endstone.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"src/mapBuilder/textures/02_water.gif", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"src/mapBuilder/textures/03_wall.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"src/mapBuilder/textures/04_+bomb.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"src/mapBuilder/textures/05_+fire.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"src/mapBuilder/textures/06_ghost.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u"src/mapBuilder/textures/07_+dynamit.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u"src/mapBuilder/textures/08_+time_bomb.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"src/mapBuilder/textures/09_+heart.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u"src/mapBuilder/textures/10_enemy.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u"src/mapBuilder/textures/11_+sword.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u"src/mapBuilder/textures/12_+atomic_bomb.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u"src/mapBuilder/textures/13_shield.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon14 = QIcon()
        icon14.addFile(u"src/mapBuilder/icons/delete.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(u"src/mapBuilder/icons/clear.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon16 = QIcon()
        icon16.addFile(u"src/mapBuilder/icons/arrow_left.png", QSize(), QIcon.Normal, QIcon.Off)
        icon16.addFile(u"src/mapBuilder/icons/arrow_left_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        ...
        icon17 = QIcon()
        icon17.addFile(u"src/mapBuilder/icons/arrow_right.png", QSize(), QIcon.Normal, QIcon.Off)
        icon17.addFile(u"src/mapBuilder/icons/arrow_right_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
